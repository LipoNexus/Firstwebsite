              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#4A4A5A] mb-0.5">Contact</p>
                      <p className="text-sm text-[#1A1A2E] font-medium">{info.name}</p>
                      <p className="text-xs text-[#4A4A5A]">{info.title}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#4A4A5A] mb-0.5">Phone</p>
                      <a
                        href={`tel:${info.phone}`}
                        className="text-sm text-[#100CC9] hover:text-[#2A28F8] font-medium transition-colors"
                      >
